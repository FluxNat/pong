...
class Discord extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            const discordDisplayName = notification.discordUsername || "Pong";
            ...
            if (heartbeatJSON == null) {
                ...
                if (!webhookHasAvatar) {
                    discordtestdata.avatar_url = "https://github.com/k4ran909/pong/raw/master/public/icon.png";
                }
            ...
            if (messageFormat === "minimalist") {
                ...
                if (!webhookHasAvatar) {
                    payload.avatar_url = "https://github.com/k4ran909/pong/raw/master/public/icon.png";
                }
                if (notification.discordChannelType === "createNewForumPost") {
            ...
            if (heartbeatJSON["status"] === DOWN) {
                ...
                if (!webhookHasAvatar) {
                    discorddowndata.avatar_url = "https://github.com/k4ran909/pong/raw/master/public/icon.png";
                }
                if (notification.discordChannelType === "createNewForumPost") {
                ...
                if (!webhookHasAvatar) {
                    discordupdata.avatar_url = "https://github.com/k4ran909/pong/raw/master/public/icon.png";
                }
