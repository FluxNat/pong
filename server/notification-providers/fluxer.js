    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            if (heartbeatJSON == null) {
                ...
                if (!webhookHasAvatar) {
                    fluxertestdata.avatar_url = "https://github.com/FluxNat/pong/raw/master/public/icon.png";
                }
            ...
            if (heartbeatJSON["status"] === DOWN) {
                ...
                if (!webhookHasAvatar) {
                    fluxerdowndata.avatar_url = "https://github.com/FluxNat/pong/raw/master/public/icon.png";
                }
                ...
                if (!webhookHasAvatar) {
                    fluxerupdata.avatar_url = "https://github.com/FluxNat/pong/raw/master/public/icon.png";
                }
                if (notification.fluxerPrefixMessage) {
