...
export function getRepoNames() {
    ...
    return ["k4ran909/pong", "ghcr.io/k4ran909/pong"];
}
 ...
 * docker buildx build -f docker/dockerfile --platform linux/amd64 -t k4ran909/pong:upload-artifact --build-arg VERSION --build-arg GITHUB_TOKEN --target upload-artifact . --progress plain
 * @param {string} version Version
...
export async function createReleasePR(version, previousVersion, dryRun, branchName = "release", githubRunId = null) {
    ...
    const artifactLink = githubRunId
        ? `https://github.com/k4ran909/pong/actions/runs/${githubRunId}/workflow`
        : `https://github.com/k4ran909/pong/actions/workflows/beta-release.yml`;
