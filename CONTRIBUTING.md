...
- <details><summary><b>Security Fixes</b> (click to expand)</summary>
  ...
  [advisory]: https://github.com/FluxNat/pong/security/advisories/new
  [issue]: https://github.com/FluxNat/pong/issues/new?template=security_issue.yml
...
- <details><summary><b>Translations / Internationalisation (i18n)</b> (click to expand)</summary>
  ...
  We use Weblate to localise this project into many languages. If you want to help translate Pong into your language, please see [these instructions on how to translate using Weblate](https://github.com/FluxNat/pong/blob/master/src/lang/README.md).
  ...
  - **Adding a new language** requires creating a new file. See [these instructions](https://github.com/FluxNat/pong/blob/master/src/lang/README.md).
...
- <details><summary><b>As a First-Time Contributor</b> (click to expand)</summary>
  ...
  1. **Fork** the [pong repository](https://github.com/FluxNat/pong/) and **clone** it to your local machine.
...
I ([@FluxNat](https://github.com/FluxNat)) have the final say.
If your pull request does not meet my expectations, I will reject it, no matter how much time
you spent on it.

We will assign your pull request to a [milestone](https://github.com/FluxNat/pong/milestones), if we plan to review and merge it.
...
See: <https://github.com/FluxNat/pong/tree/master/db/knex_migrations>
...
<https://github.com/FluxNat/pong-wiki>
...
| ----------------- | ----------------- | ---------------- |
| `@FluxNat`       | senior maintainer | major features   |
...
- <details><summary><b>Release</b> (click to expand)</summary>
  ...
  - [ ] Check all tags is fine on
        <https://hub.docker.com/r/FluxNat/pong/tags>
...
- <details><summary><b>Release Wiki</b> (click to expand)</summary>
  ...
  **Setup Repo**
  ...
  ```bash
  git clone https://github.com/FluxNat/pong-wiki.git
  cd pong-wiki
  git remote add production https://github.com/FluxNat/pong.wiki.git
  ```
