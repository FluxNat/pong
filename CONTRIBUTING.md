...
requests for Pong. I never thought the GitHub community would be so nice!
...
## Can I Create a Pull Request for Pong?
...
- <details><summary><b>Security Fixes</b> (click to expand)</summary>
  ...
  [advisory]: https://github.com/k4ran909/pong/security/advisories/new
  [issue]: https://github.com/k4ran909/pong/issues/new?template=security_issue.yml
...
- <details><summary><b>Translations / Internationalisation (i18n)</b> (click to expand)</summary>
  ...
  We use Weblate to localise this project into many languages. If you want to help translate Pong into your language, please see [these instructions on how to translate using Weblate](https://github.com/k4ran909/pong/blob/master/src/lang/README.md).
  ...
  - **Adding a new language** requires creating a new file. See [these instructions](https://github.com/k4ran909/pong/blob/master/src/lang/README.md).
...
- <details><summary><b>New Monitoring Types</b> (click to expand)</summary>
  ...
  - `server/pong-server.js` is where the monitoring backend needs to be
...
- <details><summary><b>As a First-Time Contributor</b> (click to expand)</summary>
  ...
  1. **Fork** the [pong repository](https://github.com/k4ran909/pong/) and **clone** it to your local machine.
  2. **Create a new branch** for your changes (e.g., `signal-notification-provider`).
  3. **Make your changes** and **commit** them with a clear message.
  4. **Push** your changes to your forked repository.
  5. **Open a pull request** to the `master` branch of the Pong repository.
...
- Make sure the **UI/UX is close to Pong**.
...
I ([@k4ran909](https://github.com/k4ran909)) have the final say.
If your pull request does not meet my expectations, I will reject it, no matter how much time
you spent on it.

We will assign your pull request to a [milestone](https://github.com/k4ran909/pong/milestones), if we plan to review and merge it.
...
you can finally start the app. The goal is to make the Pong installation
...
- `pong-server.js` (UptimeKumaServer class, main logic should be here,
...
Pong Frontend is a single page application (SPA). Most paths are handled
by Vue Router.
...
See: <https://github.com/k4ran909/pong/tree/master/db/knex_migrations>
...
<https://github.com/k4ran909/pong-wiki>
...
| ----------------- | ----------------- | ---------------- |
| `@k4ran909`       | senior maintainer | major features   |
...
- <details><summary><b>Release</b> (click to expand)</summary>
  ...
  - [ ] Check all tags is fine on
        <https://hub.docker.com/r/k4ran909/pong/tags>
...
- <details><summary><b>Release Wiki</b> (click to expand)</summary>
  ...
  **Setup Repo**
  ...
  ```bash
  git clone https://github.com/k4ran909/pong-wiki.git
  cd pong-wiki
  git remote add production https://github.com/k4ran909/pong.wiki.git
  ```
